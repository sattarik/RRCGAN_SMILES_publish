...
with open('./../data/trainingsets_12HA/60000_train_regular_qm9/image_train.pickle', 'rb') as f:
    X_smiles_train, X_atoms_train, X_bonds_train, y_train = pickle.load(f)

with open('./../data/trainingsets_12HA/60000_train_regular_qm9/image_test.pickle', 'rb') as f:
...
#model.save  ('./../data/nns_12HA_noemb_6b6/ae_model.h5')
#encoder.save('./../data/nns_12HA_noemb_6b6/encoder.h5')
#decoder.save('./../data/nns_12HA_noemb_6b6/decoder.h5')
