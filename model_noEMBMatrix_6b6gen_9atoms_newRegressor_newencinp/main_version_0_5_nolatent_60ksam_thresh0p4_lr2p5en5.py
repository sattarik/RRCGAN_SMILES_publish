...
discriminator.compile(loss = 'binary_crossentropy', optimizer = Adam(lr=0.000025, beta_1=0.5))
...
def build_combined(z, y,
    ...
    combined.compile(loss = ['binary_crossentropy',
                     ...
                     optimizer = Adam(0.000025, beta_1 = 0.5))
    return combined
...
threshold = 0.4 # defining accurate samples
...
generator.save('./../data/nns_9HA_noemb_6b6/generator_newthresh40.h5')
discriminator.save('./../data/nns_9HA_noemb_6b6/discriminator_newthresh40.h5')
...
output.to_csv ('./../experiments/regular_9HA_6b6latent/Regular_noscreenthresh40.csv', index=False)
...
output2.to_csv('./../experiments/regular_9HA_6b6latent/Regular_NODUP_noscreenthresh40.csv', index = False)
