...
h = Dense(1 * 1 * 129)(h)
R1 = Reshape([1, 1, 129])(h)
R2 = Reshape([1, 1, 129])(h)
...
for i in range(3):
    ...
    R1 = LeakyReLU(alpha=0.2)(B1) #LeakyReLU
...
for i in range(3):
    ...
    R2 = LeakyReLU(alpha=0.2)(B2) #LeakyReLU
...
generator.save('./../data/nns_9HA_noemb_6b6/generator_reluG.h5')
discriminator.save('./../data/nns_9HA_noemb_6b6/discriminator_reluG.h5')
...
output.to_csv ('./../experiments/regular_9HA_6b6latent/Regular_noscreenrelug.csv', index=False)
...
output2.to_csv('./../experiments/regular_9HA_6b6latent/Regular_NODUP_noscreen_relug.csv', index = False)
