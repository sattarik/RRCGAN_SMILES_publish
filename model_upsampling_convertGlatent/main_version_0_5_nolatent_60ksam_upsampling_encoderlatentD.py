...
def build_combined(z, y,
    ...
    valid = discriminator([latent_encoder_atom, latent_encoder_bond, y])
...
reinforce_n = 5 # 5*reinforce_n = fake sampling
reinforce_sample = 100 # how many samples generated for Reinforcement
...
#generator.save('./../data/nns_9HA_noemb_6b6/generator_noreinforce.h5')
#discriminator.save('./../data/nns_9HA_noemb_6b6/discriminator_noreinforce.h5')
...
output.to_csv ('./../experiments/regular_9HA_6b6latent/Regular_noscreennoreinforce.csv', index=False)
...
output2.to_csv('./../experiments/regular_9HA_6b6latent/Regular_NODUP_noscreen_noreinforce.csv', index = False)
