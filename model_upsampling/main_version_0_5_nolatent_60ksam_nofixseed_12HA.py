...
output.to_csv ('./../experiments/regular_9HA_6b6latent/Regular_noscreen12HA.csv', index=False)
...
output2.to_csv('./../experiments/regular_9HA_6b6latent/Regular_NODUP_noscreen12HA.csv', index = False)
