...
encoder = load_model('./../data/nns_9HA_noemb_6b6/encoder_newencinp2.h5')
decoder = load_model('./../data/nns_9HA_noemb_6b6/decoder_newencinp2.h5')
...
o_reg = Dropout(0.2)(o)
o_reg = Dense(1, activation = 'relu')(o_reg)
...
try:
    regressor =     load_model('./../data/nns_9HA_noemb_6b6/keep/regressor2.h5')
    regressor_top = load_model('./../data/nns_9HA_noemb_6b6/keep/regressor_top2.h5')
print (".h5 was read")
...
regressor.save('./../data/nns_9HA_noemb_6b6/regressor2.h5')
regressor_top.save('./../data/nns_9HA_noemb_6b6/regressor_top2.h5')
...
generator.save('./../data/nns_9HA_noemb_6b6/generator_notnorm.h5')
discriminator.save('./../data/nns_9HA_noemb_6b6/discriminator_notnorm.h5')
...
output.to_csv ('./../experiments/regular_9HA_6b6latent/Regular_noscreen_notnorm.csv', index=False)
...
output2.to_csv('./../experiments/regular_9HA_6b6latent/Regular_NODUP_noscreen_notnorm.csv', index = False)
