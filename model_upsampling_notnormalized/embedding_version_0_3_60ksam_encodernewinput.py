...
y_cv = Dropout(0.2)(y_cv)
y_cv = Dense(128, activation = 'relu')(y_cv)
y_cv = Dense(1, activation = 'relu')(y_cv)
...
try:
    ...
    model = load_model  ('./../data/nns_9HA_noemb_6b6/ae_model_newencinp2.h5')
...
model.save  ('./../data/nns_9HA_noemb_6b6/ae_model_newencinp2.h5')
encoder.save('./../data/nns_9HA_noemb_6b6/encoder_newencinp2.h5')
decoder.save('./../data/nns_9HA_noemb_6b6/decoder_newencinp2.h5')
